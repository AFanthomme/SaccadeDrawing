...
types2patch = {
    ...
    'line_2':  cv2.line(np.zeros((32, 32, 3), dtype=np.uint8), (8, 8), (24, 24), (0,1,0), 2).transpose(1, 0, 2),
    'line_3':  cv2.line(np.zeros((32, 32, 3), dtype=np.uint8), (8, 24), (24, 8), (0,1,0), 2).transpose(1, 0, 2),
}
