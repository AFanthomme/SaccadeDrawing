...
def run_one_seed_training(seed):
    ...
    # train(local_four_lines_ablated_args) 
...
def run_one_seed_testing(seed, n_steps_plot=10, n_steps_total=100):
    ...
    # agents = [oracle, random_agent, four_lines_no_saccades_agent, ablated_four_agent, ablated_four_only_big_peripheral_agent, four_lines_agent]

    # All of these still need to be ran !
    # Part 1:
    # agent_names = ['oracle', 'random', 'candidate']
    # agents = [oracle, random_agent, four_lines_no_saccades_agent]
              

    # agent_names = ['ablated', 'big_ablated', 'saccade_constrained']
    # agents = [ablated_four_agent, ablated_four_only_big_peripheral_agent, four_lines_agent]
...
if __name__ == '__main__':
    ...
    # pool.map(partial(run_one_seed_testing, n_steps_plot=40, n_steps_total=2000), range(n))
